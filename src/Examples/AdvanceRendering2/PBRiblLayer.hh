#ifndef LAYERS_PBR_IBL_LAYER_HH
#define LAYERS_PBR_IBL_LAYER_HH
  ...
  class PBRIBLLayer : public Layer
  {
   ...
   public:
    PBRIBLLayer()
    {
      ...
      m_camera.set_position(glm::vec3(10.0f, 5.0f, 1.8f));
      ...
      // skybox
      {
        ...
        m_skybox.m_shader = ShaderSystem::acquire("Shaders/AdvanceRendering2/PBRiblExample/skybox");
        ...
        m_skybox.m_uniform_manager->load_texture(0, 1, TextureSystem::acquire_cubemap("Textures/HDRSkybox/room.hdr"));
    ...
    std::shared_ptr<EspTexture> generate_BRDFLUt()
    {
      ...
      auto shader = ShaderSystem::acquire("Shaders/AdvanceRendering2/PBRiblExample/shader_brdflut");
    ...
    std::shared_ptr<EspTexture> generate_irradiance_cube()
    {
      ...
      auto shader = ShaderSystem::acquire("Shaders/AdvanceRendering2/PBRiblExample/shader_irradiance_cub");
      ...
      uniform_manager->load_texture(0, 0, TextureSystem::acquire_cubemap("Textures/HDRSkybox/room.hdr"));
    ...
    std::shared_ptr<EspTexture> generate_prefiltered_cube()
    {
      ...
      auto shader = ShaderSystem::acquire("Shaders/AdvanceRendering2/PBRiblExample/shader_prefilter_env_map");
