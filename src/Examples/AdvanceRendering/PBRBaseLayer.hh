   ...
   public:
    PBRBaseLayer()
    {
      ...
      // first pass
      {
        ...
        m_first_pass.m_shader = ShaderSystem::acquire("Shaders/PBRBaseExample/shader_p1");
        ...
        model_builder.load_model("Models/sphere/sphere.obj", { .layouts = {} });
      ...
      // second pass
      {
        ...
        m_second_pass.m_shader = ShaderSystem::acquire("Shaders/PBRBaseExample/shader_p2");
