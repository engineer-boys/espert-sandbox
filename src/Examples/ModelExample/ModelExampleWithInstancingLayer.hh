...
namespace model_example_with_instancing
{
  ...
  // TODO: before updating this layer add instancing first
  ...
  //      uniform_meta_data->add_push_uniform(EspUniformShaderStage::ESP_VTX_STAGE, 0,
  //      sizeof(model_example::CameraPush));
  //
